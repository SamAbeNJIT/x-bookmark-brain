...
<section>
  ...
  <div class=pricing>
    ...
    <div class=price><div class=amt>$3.99</div><div class=per>per month</div>
      <ul><li>75 questions every month</li><li>~47% off pay-as-you-go</li>
      <li>Or top up anytime: $1 = 10 questions</li></ul></div>
  </div>
